...
<div id="titulo" class="container-flex p-5" style="background-color: #F28627;">
  ...
  <div id="como_jugar" class="container p-5 text-white">
      <h1 class="text-center  display-2">CONOCE A LOS DESAROLLADORES WEB</h1>
      <p class="text-center fs-5 ">Somos un grupo de alumnos de segundo de grado superior de desarollo de aplicaciones web
          en el Instituto Provençana.</p>
  </div>
      ...
      <div class="col">
          <div class="carta-box">
              <div class="carta">    
                ...
                <div class="cara detras">
                  <div class="card">
                      <img src="https://i.pinimg.com/originals/15/8c/b2/158cb2fa5b2b7c8b2b70e195130a2b64.gif" class="card-img-top" alt="...">
                      <div class="card-body">
