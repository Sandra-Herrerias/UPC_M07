...
<div class="container text-white mt-5">
      <h2 class="text-center  display-4">Tipos de cartas</h2>
        <div id="tipos-cartas" class="row align-items-start">
          <div class="col">
            <a class="nav-link active" href="#">Pasar</a>    
          </div>
          <div class="col">
            <a class="nav-link active" href="#">Ataca</a>
          </div>
          <div class="col">
            <a class="nav-link active " href="#">Blind card</a>
          </div>
          <div class="col">
            <a class="nav-link active" href="#">Desactiva</a> 
          </div>
          <div class="col">
            <a class="nav-link active" href="#">Exploding Kitten</a> 
          </div>
          <div class="col">
            <a class="nav-link active" href="#">Favor</a> 
          </div>
          <div class="col">
            <a class="nav-link active" href="#">Ver el futuro</a>
          </div>
          <div class="col">
            <a class="nav-link active" href="#">Baraja</a> 
          </div>
        </div>
